...
const SignupPage = () => {
    ...
    const handleSignup = async () => {
        const res = await authController.signUpWithEmailAndPassword(credentials.email, credentials.password, credentials.confirmPassword)
    ...
    return (
        <div>
            ...
            <input type="password" value={credentials.confirmPassword} onChange={(e) => setCredentials({ ...credentials, confirmPassword: e.target.value })}  />
